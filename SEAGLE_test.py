...
if(False):
    ...
    # generate Sample
    mysample = seagle.insertSphere((mysample.shape[0], mysample.shape[1], mysample.shape[2]), obj_dim=0.1, obj_type=0, diameter=1, dn=myN_obj-myN_obj_embb) + myN_obj_embb
    mysample = mysample + 0j
